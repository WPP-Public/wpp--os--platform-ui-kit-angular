...
ValueAccessor.ɵfac = function ValueAccessor_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || ValueAccessor)(i0.ɵɵdirectiveInject(i0.ElementRef)); };
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ValueAccessor, [{
        type: Directive,
        args: [{}]
    }], () => [{ type: i0.ElementRef }], { _handleBlurEvent: [{
            type: HostListener,
            args: ['focusout']
        }] }); })();
