...
RadioValueAccessor.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: RadioValueAccessor, selectors: [["wpp-radio-group-v3-3-1-v3-3-1"], ["wpp-segmented-control-v3-3-1-v3-3-1"]], hostBindings: function RadioValueAccessor_HostBindings(rf, ctx) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(RadioValueAccessor, [{
        ...
        args: [{
                ...
                selector: 'wpp-radio-group-v3-3-1-v3-3-1, wpp-segmented-control-v3-3-1-v3-3-1',
                host: {
