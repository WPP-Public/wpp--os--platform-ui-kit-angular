...
RadioValueAccessor.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: RadioValueAccessor, selectors: [["wpp-radio-group-v3-6-0-v3-6-0"], ["wpp-segmented-control-v3-6-0-v3-6-0"]], hostBindings: function RadioValueAccessor_HostBindings(rf, ctx) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(RadioValueAccessor, [{
        ...
        args: [{
                ...
                selector: 'wpp-radio-group-v3-6-0-v3-6-0, wpp-segmented-control-v3-6-0-v3-6-0',
                host: {
