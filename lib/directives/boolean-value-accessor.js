...
BooleanValueAccessor.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: BooleanValueAccessor, selectors: [["wpp-checkbox-v4-1-0-v4-1-0"], ["wpp-toggle-v4-1-0-v4-1-0"]], hostBindings: function BooleanValueAccessor_HostBindings(rf, ctx) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(BooleanValueAccessor, [{
        ...
        args: [{
                ...
                selector: 'wpp-checkbox-v4-1-0-v4-1-0, wpp-toggle-v4-1-0-v4-1-0',
                host: {
