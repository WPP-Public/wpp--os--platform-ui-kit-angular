...
SelectValueAccessor.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: SelectValueAccessor, selectors: [["wpp-autocomplete-v4-2-0-v4-2-0"], ["wpp-select-v4-2-0-v4-2-0"]], hostBindings: function SelectValueAccessor_HostBindings(rf, ctx) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(SelectValueAccessor, [{
        ...
        args: [{
                ...
                selector: 'wpp-autocomplete-v4-2-0-v4-2-0, wpp-select-v4-2-0-v4-2-0',
                host: {
