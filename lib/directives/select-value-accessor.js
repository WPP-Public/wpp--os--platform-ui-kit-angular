...
SelectValueAccessor.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: SelectValueAccessor, selectors: [["wpp-autocomplete-v3-6-0-v3-6-0"], ["wpp-select-v3-6-0-v3-6-0"]], hostBindings: function SelectValueAccessor_HostBindings(rf, ctx) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(SelectValueAccessor, [{
        ...
        args: [{
                ...
                selector: 'wpp-autocomplete-v3-6-0-v3-6-0, wpp-select-v3-6-0-v3-6-0',
                host: {
